...
<form action="{{route('registered')}}" method="post">
    ...
    <input type="text" name="using" value="code" style="display:none;background-color:lightgrey;" placeholder="">
    ...
    <input type="text" name="invite_code" placeholder="Enter Invite Code (Optional)">
</div>
